...
class DAIRV2XBaseDatasetLatency(Dataset):
    ...
    def retrieve_base_data(self, idx):
        ...
        if self.load_camera_file:
            ...
            if os.path.exists(os.path.join(self.root_dir, 'infrastructure-side/calib/virtuallidar_to_camera/'+str(veh_frame_id_cur)+'.json')):
                flag=False
                ...
                flag=True
                data[1]['params']['camera0']['extrinsic'] = None
            
            if os.path.exists(os.path.join(self.root_dir, 'infrastructure-side/calib/camera_intrinsic/'+str(veh_frame_id_cur)+'.json')):
                flag=False
                ...
                flag=True
                data[1]['params']['camera0']['intrinsic'] = None
