...
from opencood.models.sub_modules.base_bev_backbone_resnet_channel16 import ResNetBEVBackbone 
...
class HeterModelSharedheadchannel16(nn.Module):
    def __init__(self, args):
        super(HeterModelSharedheadchannel16, self).__init__()
        self.args = args
