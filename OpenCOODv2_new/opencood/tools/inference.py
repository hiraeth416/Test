...
def main():
    ...
    # right hand: V2X-Sim 2.0 and DAIR-V2X, V2V4Real
    ...
    # opencood_dataset_subset = Subset(opencood_dataset, range(1510,1530))
    ...
    infer_info = opt.fusion_method + '_' + opt.note + "_no_track_" + str(opt.delay_time) + '_'
