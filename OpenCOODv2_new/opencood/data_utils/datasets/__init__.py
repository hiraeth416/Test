...
from opencood.data_utils.datasets.intermediate_fusion_multisweep_dataset import getIntermediateFusionMultiSweepDataset
...
from opencood.data_utils.datasets.basedataset.opv2vh_basedataset import OPV2VHBaseDataset
...
from opencood.data_utils.datasets.basedataset.v2xseq_basedataset import V2XSEQBaseDataset
...
def build_dataset(dataset_cfg, visualize=False, train=True):
    ...
    is_multi_sweep = dataset_cfg['fusion']['multi_sweep'] if 'multi_sweep' in dataset_cfg['fusion'] else False
    print()
    assert fusion_name in ['no','late', 'intermediate', 'intermediate2stage', 'early','intermediateheter','lateheter']
    assert dataset_name in ['opv2v', 'v2xsim', 'dairv2x', 'v2xset', 'v2xseq', 'v2v4real','opv2vh']

    if is_multi_sweep:
        fusion_dataset_func = "get" + fusion_name.capitalize() + "FusionMultiSweepDataset"
    else:
