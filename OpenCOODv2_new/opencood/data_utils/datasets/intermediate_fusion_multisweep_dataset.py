    ...
    class IntermediateFusionMultiSweepDataset(cur_cls):
        def __init__(self, params, visualize, train=True):
            ...
            if 'num_sweep_frames' in params:    
                ...
                self.k = 1
            print('num_sweep_frames: ', self.k)
            # print('len_record: ', self.len_record)
        ...
        def __getitem__(self, idx):
            ...
            for _i, cav_id in enumerate(cav_id_list):
                ...
                for t_i in range(self.k):
                    ...
                    if t_i in prev_object_stack:
                        prev_object_stack[t_i].append(selected_cav_processed['object_bbx_center'])
                        prev_object_id_stack[t_i] += selected_cav_processed['object_ids']
                    else:
                        prev_object_stack[t_i] = [selected_cav_processed['object_bbx_center']]
                        prev_object_id_stack[t_i] = selected_cav_processed['object_ids']
                    ################# FOR FLOW ##############
        ...
        def collate_batch_train(self, batch):
            ...
            for i in range(len(batch)):
                ...
                flow_map_list.append(ego_dict['flow_gt'][None,...])
