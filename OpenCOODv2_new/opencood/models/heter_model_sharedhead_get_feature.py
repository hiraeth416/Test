...
class HeterModelSharedheadGetFeature(nn.Module):
    def __init__(self, args):
        super(HeterModelSharedheadGetFeature, self).__init__()
        self.args = args
        ...
        for i in range(len(args['fusion_backbone']['layer_nums'])):
            ...
            #    self.fusion_net.append(AttFusion(args['att']['feat_dim'][i]))
                ...
                self.fusion_net.append(AttFusion(384))
            elif args['fusion_method'] == "disconet":
                self.fusion_net.append(DiscoFusion(384))
