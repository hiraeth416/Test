...
class CenterPointTestLoss(CenterPointLoss):
    def __init__(self, args):
        super(CenterPointTestLoss, self).__init__(args)
    ...
    def forward(self, output_dict, target_dict, suffix=""):
        ...
        if self.detection_loss_codebook:
            ...
            cls_loss = F.mse_loss(cls_w_channel_compression, cls_wo_channel_compression)
            bbox_loss = F.mse_loss(bbox_w_channel_compression, bbox_wo_channel_compression)
