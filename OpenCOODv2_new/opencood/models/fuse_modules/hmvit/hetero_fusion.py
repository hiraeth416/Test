...
class HeteroFusionBlock(nn.Module):
    ...
    def __init__(self, config):
        ...
        self.window_norm = HeteroLayerNorm(input_dim, num_types)
        ...
        self.grid_norm = HeteroLayerNorm(input_dim, num_types)
        ...
        self.grid_ffd = HeteroPreNormResidual(input_dim,
                                              HeteroFeedForward(input_dim, mlp_dim,
                                                        drop_out, num_types),
                                              num_types)
        self.aggregate_fc = HeteroFeedForward(mlp_dim * 3, mlp_dim, drop_out, num_types,
                                              out_dim=mlp_dim)
