...
def main():
    ...
    infer_info = opt.fusion_method + opt.note + opt.model_dir
    ...
    for i, batch_data in enumerate(data_loader):
        ...
        with torch.no_grad():
            ...
            if (i % 5 == 0) and (pred_box_tensor is not None or gt_box_tensor is not None):
                vis_save_path_unique="/GPFS/rhome/sifeiliu/OpenCOODv2_new/opencood/logs_HEAL/Figure_8_new"
                vis_save_path_root = os.path.join(vis_save_path_unique, f'vis_{infer_info}')
