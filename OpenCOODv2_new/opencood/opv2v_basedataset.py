...
class OPV2VBaseDataset(Dataset):
    ...
    def retrieve_base_data(self, idx):
        ...
        for cav_id, cav_content in scenario_database.items():
            ...
            lidar_yaml_file = cav_content[timestamp_key]['yaml'].replace(self.root_dir, self.lidar_root_dir)
            ...
            if self.load_lidar_file or self.visualize:
                data[cav_id]['lidar_np'] = \
                    pcd_utils.pcd_to_np(cav_content[timestamp_key]['lidar'].replace(self.root_dir, self.lidar_root_dir))
