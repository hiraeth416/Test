...
baseline=('opencood/logs_HEAL/Dairv2x_V2VNet_new')
...
do
 echo baseline_$i
 CUDA_VISIBLE_DEVICES=2 python opencood/tools/inference_comm_w_noise.py --model_dir $i --modal 0 --delay_time 0 --model_name baseline --range "102.4,48" --note "noise" --result_name "lidar_only_noise"
done
...
do
 echo baseline_$i
 CUDA_VISIBLE_DEVICES=2 python opencood/tools/inference_comm_w_noise.py --model_dir $i --modal 3 --delay_time 0 --model_name baseline --range "102.4,48" --note "noise" --result_name "egocamera_otherlidar_noise"
done
...
do
 echo baseline_$i
 CUDA_VISIBLE_DEVICES=2 python opencood/tools/inference_comm_w_noise.py --model_dir $i --modal 1 --delay_time 0 --model_name baseline --range "102.4,48" --note "noise" --result_name "camera_only_noise"
done
