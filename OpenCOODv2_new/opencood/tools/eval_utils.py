...
def eval_final_results(result_stat, save_path, infer_info=None, avg_time_delay=0,noise_level=0, avg_sample_interval=None, note=''):
    dump_dict = {}
    ...
    if infer_info is None:
        ...
        yaml_utils.save_yaml(dump_dict, os.path.join(save_path, f'eval_{infer_info}_{str(int(avg_sample_interval))}.yaml'))
