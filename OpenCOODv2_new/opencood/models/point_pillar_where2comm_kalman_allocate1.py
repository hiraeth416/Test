...
class PointPillarWhere2commKalmanAllocate1(nn.Module):
    def __init__(self, args):
        super(PointPillarWhere2commKalmanAllocate1, self).__init__()
    ...
    def iterateKal(self, cur_feat_list, record_len, pairwise_t_matrix, trans_mats_dict, frame_id, colla_flag=False,
        ...
        detect_feat, comm_rate, fusion_result_dict = self.fusion(feats, confidence_maps, record_len,
                                                                    ...
                                                                    channel_compression=False, config_thre=config_thre)
        # else:
        #     detect_feat = feats
        ...
        if colla_flag is False and prev_feat_box is not None:
            ...
            if box_previous is not None:
                ...
                out = self.hist_fusion_net(out, detect_feat[0].unsqueeze(0), confidence_maps_colla[0].unsqueeze(0), 0.01)
