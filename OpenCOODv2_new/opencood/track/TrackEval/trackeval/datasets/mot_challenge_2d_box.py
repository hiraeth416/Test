...
class MotChallenge2DBox(_BaseDataset):
    ...
    def __init__(self, config=None):
        ...
        print("xxxxxxxxxxxxxxxxxxxxxxxx", self.config["CLASSES_TO_EVAL"])
        ...
        for t in range(num_timesteps):
            ...
            if time_key in read_data.keys():
                ...
                try:
                    ...
                    #################### TO 3D Point Tracking ############
                    raw_data['dets'][t] = np.atleast_2d(time_data[:, 7:])
    ...
    def _calculate_similarities(self, gt_dets_t, tracker_dets_t):
        ...
        # )
        #################### TO 3D Point Tracking ############
        similarity_scores = self._calculate_euclidean_similarity(gt_dets_t, tracker_dets_t, zero_distance=100.0)
