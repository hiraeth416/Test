...
baseline=('opencood/logs_HEAL/Dairv2x_late')
...
do
 echo baseline_$i
 CUDA_VISIBLE_DEVICES=0 python opencood/tools/inference_comm_w_noise.py --model_dir $i --modal 0 --fusion_method late --delay_time 0 --model_name baseline --range "102.4,51.2" --note "noise" --result_name "lidar_only_noise"
done
...
do
 echo baseline_$i
 CUDA_VISIBLE_DEVICES=0 python opencood/tools/inference_comm_w_noise.py --model_dir $i --modal 3 --fusion_method late --delay_time 0 --model_name baseline --range "102.4,51.2" --note "noise" --result_name "egocamera_otherlidar_noise"
done
...
do
 echo baseline_$i
 CUDA_VISIBLE_DEVICES=0 python opencood/tools/inference_comm_w_noise.py --model_dir $i --modal 1 --fusion_method late --delay_time 0 --model_name baseline --range "102.4,51.2" --note "noise" --result_name "camera_only_noise"
done
