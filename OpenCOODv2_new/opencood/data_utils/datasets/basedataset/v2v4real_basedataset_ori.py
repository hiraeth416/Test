...
class V2V4REALBaseDataset(Dataset):
    ...
    def reform_param(self, cav_content, ego_content, timestamp_cur,
        ...
        delay_cav_lidar_pose = tfm_to_pose(delay_params['lidar_pose'])
        delay_ego_lidar_pose = tfm_to_pose(delay_ego_params["lidar_pose"])
        # print('delay_cav_lidar_pose: ',delay_cav_lidar_pose)
        cur_ego_lidar_pose = tfm_to_pose(cur_ego_params['lidar_pose'])
        cur_cav_lidar_pose = tfm_to_pose(cur_params['lidar_pose'])
    ...
    def generate_object_center_lidar(self,
        ...
        """
        # print("generate_object_center_camera:",reference_lidar_pose)
        # reference_lidar_pose = tfm_to_pose(reference_lidar_pose)
