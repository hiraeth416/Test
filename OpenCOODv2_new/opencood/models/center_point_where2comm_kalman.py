...
class CenterPointWhere2commKalman(nn.Module):
    def __init__(self, args):
        super(CenterPointWhere2commKalman, self).__init__()
    ...
    def iterateKal(self, cur_feat_list, record_len, pairwise_t_matrix, trans_mats_dict, frame_id, colla_flag=False,
        ...
        bbox_temp = self.generate_predicted_boxes(cls, bbox)
    ...
    def generate_predicted_boxes(self, cls_preds, box_preds, anchors=None, dir_preds=None):
        """
        Args:
            batch_size:
            cls_preds: (N, H, W, C1)
