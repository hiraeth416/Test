...
def main():
    ...
    assert opt.fusion_method in ['late', 'early', 'intermediate', 'intermediate_test', 'no', 'no_w_uncertainty', 'single'] 
        ...
        with torch.no_grad():
            ...
            if opt.fusion_method == 'late':
                ...
                infer_result = inference_utils.inference_no_fusion(batch_data,
                                                                ...
                                                                opencood_dataset,
                                                                single_gt=True)
            elif opt.fusion_method == 'intermediate_test':
                infer_result = inference_utils.inference_intermediate_test_fusion(i,
                                                                model,
                                                                opencood_dataset)
            else:
