...
m = 2
p_rate = 0.0
# m=2, num_code= [1024, 512, 256]
Quantizer0 = UMGMQuantizer(c1, m, num_code, p_rate,
                          {"latentStageEncoder": lambda: nn.Linear(c1, c1), "quantizationHead": lambda: nn.Linear(c1, c1),
                           "latentHead": lambda: nn.Linear(c1, c1), "restoreHead": lambda: nn.Linear(c1, c1),
                           "dequantizationHead": lambda: nn.Linear(c1, c1), "sideHead": lambda: nn.Linear(c1, c1)})
Quantizer1 = UMGMQuantizer(c2, m, num_code, p_rate,
                          {"latentStageEncoder": lambda: nn.Linear(c2, c2), "quantizationHead": lambda: nn.Linear(c2, c2),
                           "latentHead": lambda: nn.Linear(c2, c2), "restoreHead": lambda: nn.Linear(c2, c2),
                           "dequantizationHead": lambda: nn.Linear(c2, c2), "sideHead": lambda: nn.Linear(c2, c2)})
Quantizer2 = UMGMQuantizer(c3, m, num_code, p_rate,
                          {"latentStageEncoder": lambda: nn.Linear(c3, c3), "quantizationHead": lambda: nn.Linear(c3, c3),
                           "latentHead": lambda: nn.Linear(c3, c3), "restoreHead": lambda: nn.Linear(c3, c3),
                           "dequantizationHead": lambda: nn.Linear(c3, c3), "sideHead": lambda: nn.Linear(c3, c3)})

seg_num = 2
dict_size = [64, 128, 128]
Quantizer_multiscale = UMGMQuantizer(64, seg_num, dict_size, p_rate,
                          {"latentStageEncoder": lambda: nn.Linear(c1, c1), "quantizationHead": lambda: nn.Linear(c1, c1),
                           "latentHead": lambda: nn.Linear(c1, c1), "restoreHead": lambda: nn.Linear(c1, c1),
                           "dequantizationHead": lambda: nn.Linear(c1, c1), "sideHead": lambda: nn.Linear(c1, c1)})
# m=4, num_code=[512, 256, 128]
# m=8
