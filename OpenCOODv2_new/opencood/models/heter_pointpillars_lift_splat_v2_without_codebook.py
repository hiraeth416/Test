...
class HeterPointPillarsLiftSplatV2withoutcodebook(nn.Module):
    def __init__(self, args):
        super(HeterPointPillarsLiftSplatV2withoutcodebook, self).__init__()
    ...
    def forward(self, data_dict):
        ...
        heter_feature_2d_pre = heter_feature_2d.clone()
        ...
        heter_feature_2d = heter_feature_2d_pre
